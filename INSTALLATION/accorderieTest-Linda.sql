...
--
CREATE DATABASE IF NOT EXISTS `accorderieTest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `accorderieTest`;
...
(148, 'test', 'test', 17, '2016-03-31', '2016-04-01', 1, 0, '', 0, 4, 0, 'non', '', 0);
...
(278, '', '', '', '', '0000-00-00', '', NULL, 00000, '', NULL, NULL, '', NULL, '', '', 0, '', 'non', '2016-04-05 12:53:42', 0, 0, 0, 1),
(279, '', '', '', '', '0000-00-00', '', NULL, 00000, '', NULL, NULL, '', NULL, '', '', 0, '', 'non', '2016-04-05 12:57:10', 0, 0, 0, 1),
(280, '', '', '', '', '0000-00-00', '', NULL, 00000, '', NULL, NULL, '', NULL, '', '', 0, '', 'non', '2016-04-05 13:01:10', 0, 0, 0, 1),
...
ALTER TABLE `annonces`
 ADD PRIMARY KEY (`id`), ADD KEY `type_id` (`type_id`), ADD KEY `id_accepteur` (`id_accepteur`);
...
ALTER TABLE `evaluations`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `annonce_id` (`annonce_id`), ADD KEY `user_id` (`annonce_id`), ADD KEY `offreur_id` (`offreur_id`), ADD KEY `annonce_id_2` (`annonce_id`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`id`), ADD KEY `evaluation_id` (`evaluation_id`);
...
--
ALTER TABLE `users`
MODIFY `id` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=282;SET FOREIGN_KEY_CHECKS=1;
